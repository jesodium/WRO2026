...
const DICT = {
  en: {
    ...
    "mast.servoTitle": "Sweep camera servo (test pan)",
    "log.servoSweep": "Camera servo sweep sent",
    "toast.servoNoLink": "No BLE link — connect the bridge first",
    "toast.servoNoChar": "Bridge linked but board has no servo command — reflash the R4 & re-pair (⟳)",
    ...
    "cam.scanning": "Sage is looking around…",
    "cam.retry": "Retry",
  ...
  es: {
    ...
    "mast.servoTitle": "Barrer servo de cámara (prueba de giro)",
    "log.servoSweep": "Barrido de servo de cámara enviado",
    "toast.servoNoLink": "Sin enlace BLE — conecta el puente primero",
    "toast.servoNoChar": "Puente conectado pero la placa no tiene comando de servo — reflashea el R4 y re-emparéjate (⟳)",
    ...
    "cam.scanning": "Sage está mirando alrededor…",

...
// Mega Serial1 (D18 TX1) --voltage divider--> ESP32 GPIO16 (RX2)
...
const int MEGA_RX = 16;   // GPIO16 (RX2) <- Mega TX1 via 1k/2k divider
const int MEGA_TX = 17;   // GPIO17 (TX2) -> Mega RX1 (unused for now, future commands)
